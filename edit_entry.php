...
if (($edit_type == "series") && $repeats_allowed)
{
  ...
  // generate_radio_group($params);  //Serien Typ Deaktivirt!
  echo "</div>\n";
...
// echo "</fieldset>\n";
    ...
    //
    // echo "<div id=\"checks\">\n";
    // echo "<span id=\"conflict_check\">Conflict Check</span>\n";
    ...
    echo "<input class=\"submit_default_action\" type=\"submit\" name=\"save_button\" value=\"" .
          get_vocab("save") . "\">\n";
    echo "</div>\n";
